  ...
  return (
    <div className="flex flex-col items-center gap-6 mt-6">
      ...
      <div className="flex flex-wrap items-center justify-center space-x-8">
        <div className="flex flex-col items-center transition-transform transform hover:scale-105 duration-500 ease-in-out animate_animated animate_fadeInLeft">
          <img
            src="corana2.webp"
            alt="COVID-19"
        ...
        <div className="flex flex-col items-center transition-all duration-500 ease-in-out hover:bg-gray-100 dark:hover:bg-gray-700 p-6 rounded-lg shadow-lg animate_animated animate_fadeInRight">
          <div className="text-5xl mb-4">
            <h1 className="text-center font-bold text-gray-800 dark:text-white transform transition-transform duration-500 ease-in-out hover:scale-105 hover:text-red-500 animate_animated animatefadeIn animate_delay-1s">
              COVID-19 APP
            </h1>
          </div>
          <select
          ...
          >
            ...
            {countries.map((country: any, index: number) => (
              <option
                key={`${country.countryInfo._id}-${index}`} // Combine ID and index
                value={country.countryInfo.iso2 || `unknown-${index}`}>
